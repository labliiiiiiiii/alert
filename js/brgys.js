    ...
    if (addSingleBtn) {
        ...
        addSingleBtn.addEventListener('click', function() {
            ...
            if (modal) {
                ...
                console.log('Add Single Modal displayed');

                // Access the global variables
                const barangayName = window.barangayNameFromSession;
                const barangayId = window.barangayIdFromSession;

                // Populate the barangay input and hidden input with the fetched name and ID
                ...
                if (barangayInput && barangayIdInput) {
                    ...
                    console.log('Barangay Name set in modal:', barangayName);
                    console.log('Barangay ID set in modal:', barangayId);
                } else {
                    console.error('Barangay input not found in modal');
                }
            }
        });
    } else {
        console.error('Add Single button not found');
    }
