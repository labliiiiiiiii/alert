document.addEventListener('DOMContentLoaded', () => {
    ...
    // Get the current page filename dynamically without the .php extension
    let currentPage = window.location.pathname;
    let currentPageWithoutExtension = currentPage.split('/').pop().replace('.php', '');
    ...
    menuItems.forEach((item) => {
        ...
        // Check if the current page matches the section or if the section is part of announcement/brgys/report groups
        if (sectionFileName === currentPageWithoutExtension ||
            ...
            (brgysPages.includes(currentPageWithoutExtension) && brgysPages.includes(sectionFileName)) ||
    ...
    function logOut() {
        window.location.href = '../js/brgylogoutscript.php';
    }
    ...
    updateProfileBtn.addEventListener('click', function () {
        ...
        if (!userId) {
            ...
            showMessage('error', 'Error: Unable to find userId.');
            return;
        }
        ...
        fields.forEach(field => {
            ...
            // Validate required fields except for 'middlename'
            if (!value && field !== 'middlename') {
                allFieldsValid = false;
            }

            formData.append(field, value || ''); // Append empty value for optional fields
        });
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        proceedBtnPass.onclick = async () => {
            ...
            try {
                ...
                const response = await fetch('../server/update_brgyPassword.php', {
                    method: 'POST',
