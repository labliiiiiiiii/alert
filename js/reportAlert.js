function printTablePRINT() {
    ...
    var headerContent = document.querySelector(".AlertLog-header").outerHTML; // Get the header's outer HTML
    ...
    iframeDoc.write('<html><head><title>Print</title><style>' +
        ...
        "#printRES .AlertLog-header, #printRES .tablePRINT-container { display: none; }" +
        "@media print { " +
        "#printRES .AlertLog-header, #printRES .tablePRINT-container { display: block !important; }" +
        ...
        ".AlertLog-header { margin-bottom: 30px !important; text-align: center !important; }" +
        ".AlertLog-header p, .AlertLog-header h2, .AlertLog-header h3 { margin: 0 !important; padding: 0 !important; }" +
        ".AlertLog-header h2 { font-size: 22px !important; font-weight: bold !important; }" +
        ".AlertLog-header h3 { font-size: 20px !important; font-weight: normal !important; color: #555 !important; margin-top: 5px !important; }" +
...
function exportToPDF() {
    ...
    doc.setFontSize(12);
    doc.text("ALERT LOG", 105, 44, { align: "center" });
