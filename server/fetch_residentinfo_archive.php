...
// Function to fetch resident information from residentinfo_archive along with the Barangay name for the logged-in user
function fetchResidentInfoArchive($conn, $userId) {
    try {
        // SQL query to fetch resident information from residentinfo_archive along with the Barangay name
...
// Call the function to fetch resident information from residentinfo_archive
$residents = fetchResidentInfoArchive($conn, $userId);
