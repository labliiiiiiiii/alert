...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT password FROM admintb WHERE userid = :userid");
        ...
        $updateStmt = $conn->prepare("UPDATE admintb SET password = :password, updated_at = NOW() WHERE userid = :userid");
